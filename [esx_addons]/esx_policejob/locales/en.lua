Locales['en'] = {
  ...
  ['police_wear'] = 'standard LSPD Uniform',
  ['gilet_wear'] = 'lSPD with Traffic Vest',
  ['bullet_wear'] = 'lSPD with Bulletproof Vest',
  ...
  ['garage_store_nearby'] = 'there is no nearby vehicle.',
  ...
  ['vehicleshop_confirm'] = 'confirm Purchase',
  ...
  ['jail_menu_info'] = 'jail mine (minutes)',
  -- Vehicle interaction
  ['vehicle_info'] = 'vehicle Info',
  ['pick_lock'] = 'lockpick Vehicle',
  ['vehicle_unlocked'] = 'vehicle ~g~Unlocked~s~',
  ['no_vehicles_nearby'] = 'there is no vehicle nearby',
  ...
  ['confiscate_money'] = 'confiscate money: <span style="color:red;">$%s</span>',
